...
<body>
	...
	<h1 class="site_title">
		<a href="index.html"><img width="80%" height="80%"
			src="images/logo.png" title="Note Miage" /></a>
	</h1>
	<h2 class="section_title">Gestion des notes de la miage</h2>
	</div>
	</hgroup> </header>
	<!-- end of header bar -->
	...
	<div class="breadcrumbs_container">
		...
		<a class="current">Examen</a></article>
	</div>
	</section>
